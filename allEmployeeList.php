            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php
                    $id = $_SESSION['id'];
                    //$_SESSION['user_id'];
                    $sql_query="SELECT ed.employee_id,ed.employee_name,ed.phone_no,br.branch_name,ejd.designation FROM `employee_details` AS ed,`employee_job_details` AS ejd, branches AS br Where ed.employee_id=ejd.employee_id AND ejd.branch_code=br.branch_code and ed.user_type=2 and ejd.employment_status='active'";
                ...
                <tr>
                 ...
                 <td> <a class="btn  btn-sm  btn-warning"  href="editEmployee.php?employee_id=<?php echo $rows['employee_id']; ?>"><i class="fa fa-edit"></i></a></td>
